...
export class PlayerState {
  ...
  toObject () {
    ...
    if (typeof this.locationIngress !== 'undefined') o.locationIngress = this.locationIngress
    if (typeof this.startLocation !== 'undefined') o.startLocation = this.startLocation
    if (typeof this.sceneblob !== 'undefined') o.sceneblob = this.sceneblob
    if (typeof this.halted !== 'undefined') o.halted = this.halted
    if (typeof this.pendingExitUsed !== 'undefined') o.pendingExitUsed = this.pendingExitUsed
  ...
  // @ts-ignore
  update ({ registered, address, profile, location, locationIngress, startLocation, sceneblob, halted, pendingExitUsed, lastEID } = {}) {
